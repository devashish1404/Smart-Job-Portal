...
const initialState = {
    ...
    datePost:[
        ...
        {id:'4', name:'Last 7 Hour', value:'last-7-hour', isChecked:'false'},
        {id:'5', name:'Last 14 Hour', value:'last-14-hour', isChecked:'false'},
        {id:'6', name:'Last 30 Hour', value:'last-30-hour', isChecked:'false'},
        
    ],
    experience:[
        {id:'1', name:'Fresher', value:'fresher', isChecked:'false'},
        ...
        {id:'6', name:'5 Year', value:'5-year', isChecked:'false'},
    ],
    qualification: [
        {
            id: 1,
