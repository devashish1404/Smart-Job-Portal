  ...
  initialState: {
    ...
    reducers: {
        ...
        addDestination:(state,{payload})=>{
            state.destinaton.min = payload;
            state.destinaton.max = payload;
        },
        ...
        addExperience:(state,{payload})=>{
           ...
           if(!isExist){
            state.experiences= state.experiences.push(payload)
           } else {
        ...
        addQualification:(state,{payload})=>{
            ...
            if(!isExist){
             state.qualifications= state.qualifications.push(payload)
            } else {
