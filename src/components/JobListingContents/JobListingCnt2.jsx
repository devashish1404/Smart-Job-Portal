    ...
    return (
        <div>
            <Box sx={{ marginBottom: '10%', }} >
              ...
              {/* maingrid 1 */}
      <Grid item  xs={12} lg={6} sx={{   display: 'flex', flexDirection: 'row', justifyContent:{xs:'none',md:'space-evenly'}, }}>
                <Paper elevation={3} sx={paperStyles}>
                    ...
                    <Grid  >
                        ...
                        <Grid sx={{ color: '#696969' , display:{xs:'block',sm:'flex'}, flexDirection:'row', justifyContent:'space-evenly', alignItems:'center',marginInline:'10px'}}>
                            <Grid sx={{display:'flex', flexDirection:'row', alignItems:'center',}} >
                                <BusinessCenterIcon />
                                <Typography sx={{fontSize:'15px'}}>Segment</Typography>
                            </Grid>
                            <Grid sx={{display:'flex', flexDirection:'row', marginLeft:{xs:'0px',md:'10px'}}} >
                                <PlaceIcon  />
                        ...
                        <Grid sx={{ display: 'flex', flexDirection: 'row' }}>
                            <Grid>
                                <Button sx={{ color: '#1967D2', backgroundColor: '#1967D226', borderRadius: '24px',fontSize:'10px' }}>Full Time</Button>
                            </Grid>&nbsp;&nbsp;
                            <Grid>
                                <Button sx={{ color: '#F9AB00', backgroundColor: '#F9AB0026', borderRadius: '24px',fontSize:'10px' }}>Private</Button>
                            </Grid>
                            <Grid>
                                <Button sx={{ color: '#F9AB00', backgroundColor: '#F9AB0026', borderRadius: '24px' ,fontSize:'10px'}}>Urgent</Button>
                            </Grid>
                        </Grid>
                    </Grid>
                </Paper>
